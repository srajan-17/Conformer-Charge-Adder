...
CONFLIST CSO        CSOBK CSO01 CSO+1 CSO-2 CSO02 CSODM 
...
ATOMNAME CSO+1    13 HXT
ATOMNAME CSO+1    14  HD
ATOMNAME CSO+1    15 H16
...
ATOMNAME CSO-2     4   C
ATOMNAME CSO-2     5   O
ATOMNAME CSO-2     6 OXT
ATOMNAME CSO-2     7  OD
ATOMNAME CSO-2     8   H
ATOMNAME CSO-2     9 HN2
ATOMNAME CSO-2    10  HA
ATOMNAME CSO-2    11 HB2
ATOMNAME CSO-2    12 HB3
ATOMNAME CSO-2    13  HD
...
#ONNECT   conf atom  orbital  ires conn ires conn ires conn ires conn 
#ONNECT |-----|----|---------|----|----|----|----|----|----|----|----|----|----|
CONNECT  CSO+1  N      sp3     0    CA   0    H    0   HN2   0   H16  
...
CONNECT  CSO+1  O      sp2     0    C   
CONNECT  CSO+1 OXT     sp3     0    C    0   HXT  
...
CONNECT  CSO+1 HXT      s      0   OXT  
CONNECT  CSO+1  HD      s      0    OD  
CONNECT  CSO+1 H16      s      0    N   

#  CSO-2
#ONNECT   conf atom  orbital  ires conn ires conn ires conn ires conn 
#ONNECT |-----|----|---------|----|----|----|----|----|----|----|----|----|----|
CONNECT  CSO-2  N      sp3     0    CA   0    H    0   HN2  
CONNECT  CSO-2  CA     sp3     0    N    0    CB   0    C    0    HA  
CONNECT  CSO-2  CB     sp3     0    CA   0    SG   0   HB2   0   HB3  
CONNECT  CSO-2  SG     sp3     0    CB   0    OD  
CONNECT  CSO-2  C      sp2     0    CA   0    O    0   OXT  
CONNECT  CSO-2  O    unknown   0    C   
CONNECT  CSO-2 OXT   unknown   0    C   
CONNECT  CSO-2  OD     sp3     0    SG   0   HXT  
CONNECT  CSO-2  H       s      0    N   
CONNECT  CSO-2 HN2      s      0    N   
CONNECT  CSO-2  HA      s      0    CA  
CONNECT  CSO-2 HB2      s      0    CB  
CONNECT  CSO-2 HB3      s      0    CB  
CONNECT  CSO-2  HD      s      0    OD  
...
CHARGE   CSO+1  N   -0.8405
CHARGE   CSO+1  CA   0.0888
CHARGE   CSO+1  CB  -0.1128
CHARGE   CSO+1  SG    0.014
CHARGE   CSO+1  C     0.617
CHARGE   CSO+1  O   -0.5077
CHARGE   CSO+1  OXT -0.5549
CHARGE   CSO+1  OD  -0.5087
CHARGE   CSO+1  H    0.4778
CHARGE   CSO+1  HN2  0.4778
CHARGE   CSO+1  HA   0.1517
CHARGE   CSO+1  HB2  0.1349
CHARGE   CSO+1  HB3  0.1349
CHARGE   CSO+1  HXT  0.4932
CHARGE   CSO+1  HD   0.4568
CHARGE   CSO+1  H16  0.4778

CHARGE   CSO-2  N   -0.9188
CHARGE   CSO-2  CA   0.0436
CHARGE   CSO-2  CB  -0.0484
CHARGE   CSO-2  SG  -0.0873
CHARGE   CSO-2  C     0.913
CHARGE   CSO-2  O    -0.829
CHARGE   CSO-2  OXT  -0.829
CHARGE   CSO-2  OD  -0.5351
CHARGE   CSO-2  H    0.3454
CHARGE   CSO-2  HN2  0.3454
CHARGE   CSO-2  HA     0.05
CHARGE   CSO-2  HB2  0.0772
CHARGE   CSO-2  HB3  0.0772
CHARGE   CSO-2  HD   0.3958
